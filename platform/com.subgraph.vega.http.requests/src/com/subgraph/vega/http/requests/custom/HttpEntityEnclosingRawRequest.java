...
public class HttpEntityEnclosingRawRequest extends HttpEntityEnclosingRequestBase implements IHttpRawRequest {
	private String rawRequestLine;
	private String method;

    public HttpEntityEnclosingRawRequest(final String rawRequestLine, final String method) {
        super();
		this.rawRequestLine = rawRequestLine;
        this.method = method;
    }

    public HttpEntityEnclosingRawRequest(final String rawRequestLine, final String method, final URI uri) {
        super();
		this.rawRequestLine = rawRequestLine;
        this.method = method;
        setURI(uri);
